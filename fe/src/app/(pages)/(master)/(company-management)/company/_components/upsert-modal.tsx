...
interface UpsertProps {
  onCancel: () => void;
  onSuccess: () => void;
  data?: Record<string, unknown> | null | CompanyResponse;
  pathTable?: string;
  title: string;
  role?: string;
  moduleName: string;
...
export default function UpsertCompanyForm(props: UpsertProps) {
  const [form] = useForm();
      ...
      >
        ...
        >
          <Input
            ...
            disabled={handleReadOnlyField("company_code")}
          />
        </Form.Item>
        <Form.Item
          required
        ...
        >
          <Input
            ...
            disabled={handleReadOnlyField("company_name")}
          />
        </Form.Item>
